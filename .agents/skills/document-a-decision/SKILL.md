...
description: Decide where a piece of Terrarium knowledge belongs and write it there — an ADR in docs/adr/, an investigation in docs/investigations/, or a tuning lesson in docs/tuning-lessons.md. Use after making a structural choice, after a measurement contradicts what the model was believed to do, after abandoning a feature, or when asked to "document this decision" and the register isn't obvious.
---
...
| `docs/tuning-lessons.md` | calibration knowledge, read beside the constants it governs | living |
...
**3. Is it a number, or how to pick one?** → **tuning lesson in `docs/tuning-lessons.md`**.
...
A bullet in `docs/tuning-lessons.md`. Match the existing voice:
