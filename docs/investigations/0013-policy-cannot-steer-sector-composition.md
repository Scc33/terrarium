...
ADR-0032 removed the constraint and the elasticity went to 0.45, so Meridia now runs 33.4 → 34.2
across four hundred quarters. The regularity this investigation flagged as running backwards now
runs forwards.
