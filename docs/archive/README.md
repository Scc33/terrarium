...
`../tech-architecture.md`, `../proposal-1.md`, and `../adr/`.

| document | what it was | superseded by |
|----------|-------------|---------------|
| `proposal-0.md` | The original brainstorm write-up. First statement of the design bet ("accuracy and fun are the same thing"), the three player layers, and cobra effects as gameplay. | `../proposal-1.md`, which restates these as decisions rather than options |
