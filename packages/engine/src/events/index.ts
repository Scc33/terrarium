 ...
 * - `rules.ts` — the declarative conditions that may become stories.
 * - `conditions.ts` — the desk machinery that budgets and files those stories.
 *
...
export { CONDITION_RULES, back, medianAge } from './rules'
export type { ConditionRule, EventContext, RuleClass } from './rules'
