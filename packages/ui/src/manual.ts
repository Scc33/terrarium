...
const cabinetSections = (): ManualSection[] => [
  ...
  },
  {
    ...
    body: [
      'Capacity is the slowest and most valuable thing on the desk. A funding programme is paid over eight quarters and arrives over the same eight, so nothing you build here helps this year. Everything else you do is scaled by what you built.',
    ],
    ...
    sections: [
      {
        ...
        body: [
          'The fog is not a display effect layered over a known truth. It is manufactured inside the simulation, by a statistical office that is a real institution with a budget, and it is causal: the political system reads the PUBLISHED headline, not the truth. Your approval, your political capital and your CPI-indexed appropriations all move on numbers that may later turn out to have been wrong.',
      ...
      },
      {
        ...
        entries: [
          ...
          {
            term: 'Not exact',
            detail: 'Every print carries an error band, and the band is honest: it is the office’s own estimate of its uncertainty. Capacity narrows it substantially but never to zero. Level series carry proportional error, rates carry absolute error, so a small share and a large one are not measured to the same precision.',
            meta: 'NOISE',
          },
          {
            term: 'Not final',
      ...
      },
      {
        heading: 'THE WIRE',
        body: [
          'The news wire is rumour, not statistics. It is generated by the same office machinery and it is sometimes wrong — a dispatch is a lead, not a reading. Treating the wire as an instrument is a specific, deliberate way to lose.',
        ],
      },
      {
        heading: 'WHAT IS NEVER FOGGED',
        body: [
          'Some things the government does not need a survey to know, because it wrote them. The treasury’s own books — revenue, outlays, balance, debt, reserves, money printed — are exact. So is the schedule of who a programme pays, which is why the cabinet can show you the incidence of a draft before you enact it.',
          'What the cabinet will not preview is how households will FEEL about a change. That would be a preview of your own score.',
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        entries: [
          ...
          { term: 'Trade', detail: 'External flows are booked, reserves move, the exchange rate settles.', meta: '8' },
          { term: 'Fiscal', detail: 'Taxes are collected at the strength of your tax office; programmes are paid out with the leakage your civil service imposes; anything lenders will not finance is printed.', meta: '9' },
          { term: 'Monetary', detail: 'Inflation expectations adapt to what has been happening. Printing feeds them.', meta: '10' },
          { term: 'Prices', detail: 'Sector prices grope toward market clearing around a cost anchor. Unit costs are computed at normal utilisation, not at what was actually produced — otherwise a demand dip would raise unit costs and spiral.', meta: '11' },
          { term: 'Labour', detail: 'Employment, wages and capital accumulation. Wages need all three legs: a slack anchor, productivity passthrough near full employment, and stickiness downward.', meta: '12' },
          { term: 'Classes', detail: 'Incomes and savings by class; approval drifts toward conditions as they were actually experienced.', meta: '13' },
          { term: 'Institutions', detail: 'Societal power, the veto players’ strength, and revolutionary pressure are all re-derived from the economy that just happened.', meta: '14' },
          { term: 'Statistics', detail: 'The office measures the quarter, files it, and releases whatever falls due — first prints, revisions, and rumours for the wire.', meta: '15' },
          { term: 'Politics', detail: 'Political capital accrues from the PUBLISHED numbers. Elections, revolts and coups resolve here.', meta: '16' },
        ],
      },
      {
