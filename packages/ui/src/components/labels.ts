...
export const NAMES: Record<IndicatorId, IndicatorNames> = {
  ...
  human_capital: { dossier: 'WORKFORCE SKILLS · IDX', terminal: 'WORK.SKILL IDX', plate: 'WORKFORCE SKILLS', short: 'SKILLS', needs: 'EDUCATION CENSUS', note: 'Skills carried by the workforce. Schools raise them slowly as taught generations enter work; they help the country use better technology and staff research.' },
  ...
  asset_prices: { dossier: 'ASSET VALUATION · COST=100', terminal: 'ASSET.VAL IDX', plate: 'ASSET VALUATION', short: 'ASSET VAL', needs: 'EXCHANGE BOARD', note: 'Market value compared with the cost of replacing the country’s productive assets. 100 means equal; above it encourages investment, below it holds investment back. Growth alone does not move the ratio.' },
