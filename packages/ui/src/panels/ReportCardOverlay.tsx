...
import type { PublishedState, ReportCard } from '@terrarium/observation'
import { Overlay } from '../components/Overlay'

const yearOf = (q: number) => 1946 + Math.floor(q / 4)

function Axis({ name, children }: { name: string; children: React.ReactNode }) {
  return (
